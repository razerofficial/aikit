...
class TestDownloadCommand:
    ...
    def test_download_command_new_model(self, mocker, app, runner):
        ...
        mock_check_downloaded = mocker.patch("rzr_aikit.model.download.check_if_downloaded")
        mock_download_model = mocker.patch("rzr_aikit.model.download.download_model")
    ...
    def test_check_if_downloaded_true(self, mocker):
        ...
        mock_has_weights = mocker.patch("rzr_aikit.model.list.has_weights")

        from rzr_aikit.model.download import check_if_downloaded
